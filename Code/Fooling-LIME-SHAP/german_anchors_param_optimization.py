...
def experiment_main():
	...
	print('---------------------')
	print("Beginning Anchors GERMAN parameter optimization....")
	...
	for perturbation_multiplier_anchors in [2,2,2,2,2]:
		for n_samples_per_tuple in [1,1,1,1,1]:
			for p in [0.6,0.6,0.6,0.6]:
	...
	#print(df)
	filename = "german_anchors_variation.csv"
